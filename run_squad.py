...
flags.DEFINE_integer('predict_batch_size', 8, 'Total batch size for predicting.')
...
def get_model(albert_config, max_seq_length, init_checkpoint, learning_rate,
    ...
    _, sequence_output = albert_layer(input_word_ids, input_mask, input_type_ids)
    ...
    squad_logits_layer = ALBertSquadLogitsLayer(initializer=initializer, float_type=float_type, name='squad_logits')
    ...
    squad_model.optimizer = lamp_optimizer
